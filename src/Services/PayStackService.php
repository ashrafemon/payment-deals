...
use Leafwrap\PaymentDeals\Providers\PayStack;

class PayStackService extends BaseService implements ServiceContract
{
    ...
    private function init(): ?PayStack
    {
        $service = new PayStack(BaseService::$paymentGateway->credentials['secret_key'] ?? '');
